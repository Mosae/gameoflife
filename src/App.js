...
export default class App extends Component {
	...
	startGame() {
		if (!this.state.gameRunning) {
			this.setState(
				...
				() => {
					this.intervalRef = setInterval(() => this.runGame());
				}
			);
		}
	}
	...
	//this will run the logic and give us a universe for ech generation
	runGame() {
		this.setState({
	...
	//this will give us the playing board and also account for a cell being alive or dead
	renderBoard() {
		var newWorld = [];
		var cellRow = [];
